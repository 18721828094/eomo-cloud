...
public class LogMonitorTopologyMain {
    private static Logger logger = LoggerFactory.getLogger(LogMonitorTopologyMain.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 初始化配置信息
        SpoutConfig spoutConfig = new SpoutConfig(hosts, "logmonitor", "/eomo", "log_monitor");
        // 在topology中设置spout
